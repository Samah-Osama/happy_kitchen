...
const kPrimaryColorDarkMode = Color(0xFFFFC20D);
const kPrimaryColorLightMode = Color.fromARGB(255, 255, 113, 103);
const kSecondaryColorD = Color(0xFFF2B501);
const kDarkColor = Colors.black;
const kDarkGreyColor = Color(0xFF2C2C2C);
const kLightPinkColor = Color.fromARGB(255, 252, 170, 165);
const kLightGreyColor = Color.fromARGB(255, 90, 82, 82);
...
const kSecondaryColorLightM = Color.fromARGB(255, 238, 105, 96);
const details =
...
const kRecipeBox = 'recipe_box';
const kRecipeModelBox = 'FavoriteBox';
